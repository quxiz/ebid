            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="member">
                    <div class="container">
                        <h4>Add a Member</h4>
                        <div>
                            <c:url var="addAction" value="/testDB/member/saveMember" ></c:url>
                            ...
                            <table class="table table-striped">
                                ...
                                <c:forEach items="${listMembers}" var="member">
                                    <tr>
                                        ...
                                        <td><a href="${pageContext.request.contextPath}/testDB/member/viewMember/${member.memberID}"><i class="glyphicon glyphicon-wrench" aria-hidden="true"></i></a></td>
                                        <td><a href="${pageContext.request.contextPath}/testDB/member/findByMemberID/${member.memberID}">findByMemberID/${member.memberID}</a></td>
                                        <td><a href="${pageContext.request.contextPath}/testDB/member/findByActivateKey/${member.activateKey}">findByActivateKey/${member.activateKey}</a></td>
                                        <td><a href="${pageContext.request.contextPath}/testDB/member/findByUserID/${member.userID}">findByUserID/${member.userID}</a></td>
                                        <td><a href="${pageContext.request.contextPath}/testDB/member/findByEmail/${member.email}">findByEmail/${member.email}</a></td>
                                    </tr>
                                </c:forEach>
                            </table>
                        </c:if>
